<template>
    <div>
        <div class="pt-6 text-center">
            <h1 class="text-black font-serif text-2xl">سبد خرید</h1>
        </div>
            ...
            <div class="mt-6">
                <div class="w-full flex flex-row-reverse justify-start">
                    ...
                    <div class="flex flex-col ml-auto">
                        <h1
                            class="font-serif-bold text-sm -mt-1 tracking-wide text-gray-900"
                        >
                            {{ order.product.title }}
                        </h1>
                ...
                <span
                    class="float-right my-3 font-serif-bold bg-green-100 text-green-800 px-4 py-2 rounded font-bold text-xs"
                    >{{ order.item.presets[0].value.value }}</span
                >
            </div>
