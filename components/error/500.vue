<template>
	<div class="h-auto bg-gray-100">
		<div class="pt-32 pb-20 text-center">
			<p
				class="text-gray-900 p-2 rounded w-1/2 border mx-auto border-gray-500 h-auto hover:border-gray-100 hover:bg-red-200 hover:text-red-900"
			>
				متاسفیم! مشکلی در سرور پیش امده
			...
			<p
				dir="ltr"
				class="text-gray-900 py-4 select-all rounded h-auto w-1/2 border mx-auto border-gray-500 h-auto hover:border-gray-100 hover:bg-red-200 hover:text-red-900"
			/>
		</div>
		<div class="flex justify-center items-center">
			...
			>
				...
				<rect
					...
					opacity="0.8"
				/>
				<rect x="317.60911" y="150" width="16" height="16" fill="#38d39f" />
				<rect
					x="271.60911"
					y="251"
					width="16"
				...
				<rect
					...
					opacity="0.8"
				/>
				<rect x="317.60911" y="251" width="16" height="16" fill="#38d39f" />
				<rect
					x="271.60911"
					y="352"
					width="16"
				...
				<rect
					...
					opacity="0.8"
				/>
				<rect x="317.60911" y="352" width="16" height="16" fill="#38d39f" />
