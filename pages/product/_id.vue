<template>
	<div class="bg-gray-100 flex px-20 py-12 mt-28">
		<div class="w-2/5 pl-16">
			...
			<span class="block font-serif-light text-gray-800 pb-3">خاکستری</span>
			<span class="block py-3 text-gray-800 font-bold">
				{{ products.minimum_price | numeral('0,0') }} تومان
			</span>
					...
					<template v-for="item in guarantiesList">
						...
						>
							<a
								...
								@click="handleSelectedGuaranty(item.id, guaranty.value.value)"
							>
